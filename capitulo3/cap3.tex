...
values: http://en.wikipedia.org/wiki/Comma-separated_values}, que es un formato
de lo más sencillo. Este formato se utiliza para almacenar información en forma
de tabla, y está soportado por casi cualquier programa, que es uno de los
motivos por el que lo utilizaremos.
