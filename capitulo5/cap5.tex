...
En nuestra implementación optamos por usar  sqlLite porque sencillez para la
...
El principal problema de sqlLite es que no puede albergar muchos datos, pero en
